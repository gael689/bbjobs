...
# 1. Importar settings para leer DATABASE_URL
from app.core.config import settings

# 2. Importar la base y todos los modelos para el soporte de autogenerate
from app.models.base import Base
import app.models  # asegura que todos estén cargados
